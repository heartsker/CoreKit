...
public struct TextWithIconView: View {
    ...
    public init(_ text: String, _ icon: Imaginator.Symbol, iconColor: Color = Palette.graphicsPrimary) {
        self.text = text
        self.icon = icon
    ...
    public init(_ icon: Imaginator.Symbol, _ text: String, iconColor: Color = Palette.graphicsPrimary) {
        self.text = text
        self.icon = icon
        self.iconColor = iconColor
        self.iconFirst = true
